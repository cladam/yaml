...
// Koka generated module: std/core/bool, koka version: 3.2.3, platform: 64-bit
#include <kklib.h>
...
static inline kk_string_t kk_std_core_bool_show(bool b, kk_context_t* _ctx) { /* (b : bool) -> string */ 
  if (b) {
    kk_define_string_literal(static, _s_x15, 4, "True", _ctx)
    return kk_string_dup(_s_x15, _ctx);
  }
  {
    kk_define_string_literal(static, _s_x16, 5, "False", _ctx)
