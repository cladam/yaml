...
static inline kk_std_core_hnd__htag kk_std_core_hnd_ev_fs_htag(kk_std_core_hnd__ev ev, kk_context_t* _ctx) { /* forall<a> (ev : ev<a>) -> htag<a> */ 
  {
    struct kk_std_core_hnd_Ev* _con_x310 = kk_std_core_hnd__as_Ev(ev, _ctx);
    kk_std_core_hnd__htag _x = _con_x310->htag;
...
static inline kk_box_t kk_std_core_hnd_local_var(kk_box_t init, kk_function_t action, kk_context_t* _ctx) { /* forall<a,b,e,h> (init : a, action : (local-var<h,a>) -> <local<h>|e> b) -> <local<h>|e> b */ 
  ...
  kk_box_t res;
  kk_ref_t _x_x354 = kk_ref_dup(loc, _ctx); /*local-var<4257,4254>*/
  res = kk_function_call(kk_box_t, (kk_function_t, kk_ref_t, kk_context_t*), action, (action, _x_x354, _ctx), _ctx); /*4255*/
...
static inline kk_box_t kk_std_core_hnd_finally(kk_function_t fin, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (fin : () -> e (), action : () -> e a) -> e a */ 
  kk_box_t _x_x359 = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), action, (action, _ctx), _ctx); /*4444*/
  return kk_std_core_hnd_finally_prompt(fin, _x_x359, _ctx);
}
...
static inline kk_box_t kk_std_core_hnd_resume(kk_std_core_hnd__resume_context r, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e,e1,b> (r : resume-context<a,e,e1,b>, x : a) -> e b */ 
  {
    ...
    kk_std_core_hnd__resume_result _x_x376 = kk_std_core_hnd__new_Deep(x, _ctx); /*hnd/resume-result<74,75>*/
...
static inline kk_box_t kk_std_core_hnd_resume_shallow(kk_std_core_hnd__resume_context r, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e,e1,b> (r : resume-context<a,e,e1,b>, x : a) -> e1 b */ 
  {
    kk_function_t _x = r.k;
    kk_std_core_hnd__resume_result _x_x377 = kk_std_core_hnd__new_Shallow(x, _ctx); /*hnd/resume-result<74,75>*/
    return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__resume_result, kk_context_t*), _x, (_x, _x_x377, _ctx), _ctx);
  }
}
...
static inline kk_box_t kk_std_core_hnd_finalize(kk_std_core_hnd__resume_context r, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e,e1,b> (r : resume-context<a,e,e1,b>, x : b) -> e b */ 
  {
    kk_function_t _x = r.k;
    kk_std_core_hnd__resume_result _x_x378 = kk_std_core_hnd__new_Finalize(x, _ctx); /*hnd/resume-result<74,75>*/
    return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__resume_result, kk_context_t*), _x, (_x, _x_x378, _ctx), _ctx);
  }
}
...
static inline kk_box_t kk_std_core_hnd__perform1(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x, kk_context_t* _ctx) { /* forall<a,b,c,e> (ev : ev<c>, op : forall<e1,d> (c<e1,d>) -> clause1<a,b,c,e1,d>, x : a) -> e b */ 
  {
    ...
    int32_t m = _con_x382->marker;
    kk_box_t h = _con_x382->hnd;
    kk_box_dup(h, _ctx);
    kk_std_core_hnd__clause1 _match_x250 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx), _ctx); /*hnd/clause1<5306,5307,5308,835,836>*/;
    {
...
struct kk_std_core_hnd_under1_fun390__t {
...
static inline kk_function_t kk_std_core_hnd_new_under1_fun390(kk_std_core_hnd__ev ev, kk_context_t* _ctx) {
  struct kk_std_core_hnd_under1_fun390__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_under1_fun390__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_under1_fun390, kk_context());
  _self->ev = ev;
...
static inline kk_box_t kk_std_core_hnd_under1(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x, kk_context_t* _ctx) { /* forall<a,b,e,c> (ev : ev<c>, op : (a) -> e b, x : a) -> e b */ 
  ...
  kk_evv_t _x_x388;
  {
    struct kk_std_core_hnd_Ev* _con_x389 = kk_std_core_hnd__as_Ev(ev, _ctx);
    kk_evv_t w = _con_x389->hevv;
    kk_evv_dup(w, _ctx);
    _x_x388 = w; /*hnd/evv<5350>*/
  }
  w0 = kk_evv_swap(_x_x388,kk_context()); /*hnd/evv<_5497>*/
  kk_box_t y = kk_function_call(kk_box_t, (kk_function_t, kk_box_t, kk_context_t*), op, (op, x, _ctx), _ctx); /*5584*/;
  if (kk_yielding(kk_context())) {
    kk_box_drop(y, _ctx);
    kk_evv_drop(w0, _ctx);
    return kk_std_core_hnd_yield_cont(kk_std_core_hnd_new_under1_fun390(ev, _ctx), _ctx);
  }
  {
...
// lift anonymous function
struct kk_std_core_hnd_clause_control1_fun404__t {
  struct kk_function_s _base;
  kk_function_t clause;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_control1_fun404(kk_function_t clause, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control1_fun404__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control1_fun404__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_control1_fun404, kk_context());
  _self->clause = clause;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_control1_fun405__t {
  struct kk_function_s _base;
  kk_function_t clause;
  kk_box_t x;
};
extern kk_box_t kk_std_core_hnd_clause_control1_fun405(kk_function_t _fself, kk_function_t k, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_hnd_new_clause_control1_fun405(kk_function_t clause, kk_box_t x, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control1_fun405__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control1_fun405__t, 3, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_control1_fun405, kk_context());
  _self->clause = clause;
  _self->x = x;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause1 kk_std_core_hnd_clause_control1(kk_function_t clause, kk_context_t* _ctx) { /* forall<a,b,e,c,d> (clause : (x : a, k : (b) -> e d) -> e d) -> clause1<a,b,c,e,d> */ 
  return kk_std_core_hnd__new_Clause1(kk_std_core_hnd_new_clause_control1_fun404(clause, _ctx), _ctx);
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_tail_noop1_fun410__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noop1_fun410(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noop1_fun410__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noop1_fun410__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_tail_noop1_fun410, kk_context());
  _self->op = op;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause1 kk_std_core_hnd_clause_tail_noop1(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d> (op : (c) -> e d) -> clause1<c,d,b,e,a> */ 
  return kk_std_core_hnd__new_Clause1(kk_std_core_hnd_new_clause_tail_noop1_fun410(op, _ctx), _ctx);
}
...
static inline kk_box_t kk_std_core_hnd__perform0(kk_std_core_hnd__ev ev, kk_function_t op, kk_context_t* _ctx) { /* forall<a,e,b> (ev : ev<b>, op : forall<e1,c> (b<e1,c>) -> clause0<a,b,e1,c>) -> e a */ 
  {
    ...
    kk_box_dup(h, _ctx);
    kk_std_core_hnd__clause0 _match_x243 = kk_function_call(kk_std_core_hnd__clause0, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx), _ctx); /*hnd/clause0<6617,6619,1012,1013>*/;
    {
...
// lift anonymous function
struct kk_std_core_hnd_under0_fun422__t {
  struct kk_function_s _base;
  kk_std_core_hnd__ev ev;
};
extern kk_box_t kk_std_core_hnd_under0_fun422(kk_function_t _fself, kk_function_t cont_0, kk_box_t res_0, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_hnd_new_under0_fun422(kk_std_core_hnd__ev ev, kk_context_t* _ctx) {
  struct kk_std_core_hnd_under0_fun422__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_under0_fun422__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_under0_fun422, kk_context());
  _self->ev = ev;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_box_t kk_std_core_hnd_under0(kk_std_core_hnd__ev ev, kk_function_t op, kk_context_t* _ctx) { /* forall<a,e,b> (ev : ev<b>, op : () -> e a) -> e a */ 
  ...
  kk_evv_t _x_x417;
  {
    ...
    kk_evv_t w = _con_x418->hevv;
    kk_evv_dup(w, _ctx);
    _x_x417 = w; /*hnd/evv<5350>*/
  }
  w0 = kk_evv_swap(_x_x417,kk_context()); /*hnd/evv<_6641>*/
...
// lift anonymous function
struct kk_std_core_hnd_clause_tail_noop0_fun438__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noop0_fun438(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noop0_fun438__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noop0_fun438__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_tail_noop0_fun438, kk_context());
  _self->op = op;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause0 kk_std_core_hnd_clause_tail_noop0(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c> (op : () -> e c) -> clause0<c,b,e,a> */ 
  return kk_std_core_hnd__new_Clause0(kk_std_core_hnd_new_clause_tail_noop0_fun438(op, _ctx), _ctx);
}


// lift anonymous function
struct kk_std_core_hnd_clause_value_fun439__t {
  struct kk_function_s _base;
  kk_box_t v;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_value_fun439(kk_box_t v, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_value_fun439__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_value_fun439__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_value_fun439, kk_context());
  _self->v = v;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause0 kk_std_core_hnd_clause_value(kk_box_t v, kk_context_t* _ctx) { /* forall<a,e,b,c> (v : a) -> clause0<a,b,e,c> */ 
  return kk_std_core_hnd__new_Clause0(kk_std_core_hnd_new_clause_value_fun439(v, _ctx), _ctx);
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_control2_fun454__t {
  struct kk_function_s _base;
  kk_function_t clause;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_control2_fun454(kk_function_t clause, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control2_fun454__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control2_fun454__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_control2_fun454, kk_context());
  _self->clause = clause;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_control2_fun455__t {
  struct kk_function_s _base;
  kk_function_t clause;
  kk_box_t x1;
  kk_box_t x2;
...
static inline kk_function_t kk_std_core_hnd_new_clause_control2_fun455(kk_function_t clause, kk_box_t x1, kk_box_t x2, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control2_fun455__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control2_fun455__t, 4, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_control2_fun455, kk_context());
  _self->clause = clause;
  _self->x1 = x1;
  _self->x2 = x2;
  return kk_datatype_from_base(&_self->_base, kk_context());
...
static inline kk_std_core_hnd__clause2 kk_std_core_hnd_clause_control2(kk_function_t clause, kk_context_t* _ctx) { /* forall<a,b,c,e,d,a1> (clause : (x1 : a, x2 : b, k : (c) -> e a1) -> e a1) -> clause2<a,b,c,d,e,a1> */ 
  return kk_std_core_hnd__new_Clause2(kk_std_core_hnd_new_clause_control2_fun454(clause, _ctx), _ctx);
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_tail2_fun459__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail2_fun459(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail2_fun459__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail2_fun459__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_tail2_fun459, kk_context());
  _self->op = op;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause2 kk_std_core_hnd_clause_tail2(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d,a1> (op : (c, d) -> e a1) -> clause2<c,d,a1,b,e,a> */ 
  return kk_std_core_hnd__new_Clause2(kk_std_core_hnd_new_clause_tail2_fun459(op, _ctx), _ctx);
}


// lift anonymous function
struct kk_std_core_hnd_clause_tail_noop2_fun460__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noop2_fun460(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noop2_fun460__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noop2_fun460__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_tail_noop2_fun460, kk_context());
  _self->op = op;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause2 kk_std_core_hnd_clause_tail_noop2(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d,a1> (op : (c, d) -> e a1) -> clause2<c,d,a1,b,e,a> */ 
  return kk_std_core_hnd__new_Clause2(kk_std_core_hnd_new_clause_tail_noop2_fun460(op, _ctx), _ctx);
}
...
static inline kk_box_t kk_std_core_hnd__perform2(kk_std_core_hnd__ev evx, kk_function_t op, kk_box_t x, kk_box_t y, kk_context_t* _ctx) { /* forall<a,b,c,e,d> (evx : ev<d>, op : forall<e1,a1> (d<e1,a1>) -> clause2<a,b,c,d,e1,a1>, x : a, y : b) -> e c */ 
  {
    struct kk_std_core_hnd_Ev* _con_x461 = kk_std_core_hnd__as_Ev(evx, _ctx);
    int32_t m = _con_x461->marker;
    kk_box_t h = _con_x461->hnd;
    kk_box_dup(h, _ctx);
...
static inline kk_box_t kk_std_core_hnd_xperform1(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x, kk_context_t* _ctx) { /* forall<a,b,e,c> (ev : ev<c>, op : forall<e1,d> (c<e1,d>) -> clause1<a,b,c,e1,d>, x : a) -> e b */ 
  {
    struct kk_std_core_hnd_Ev* _con_x464 = kk_std_core_hnd__as_Ev(ev, _ctx);
    int32_t m = _con_x464->marker;
    kk_box_t h = _con_x464->hnd;
    kk_box_dup(h, _ctx);
...
// lift anonymous function
struct kk_std_core_hnd_clause_tail_noop3_fun477__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noop3_fun477(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noop3_fun477__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noop3_fun477__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_tail_noop3_fun477, kk_context());
  _self->op = op;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause1 kk_std_core_hnd_clause_tail_noop3(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d,a1,b1> (op : (c, d, a1) -> e b1) -> clause1<(c, d, a1),b1,b,e,a> */ 
  return kk_std_core_hnd__new_Clause1(kk_std_core_hnd_new_clause_tail_noop3_fun477(op, _ctx), _ctx);
}
...
static inline kk_box_t kk_std_core_hnd__perform3(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x1, kk_box_t x2, kk_box_t x3, kk_context_t* _ctx) { /* forall<a,b,c,d,e,a1> (ev : ev<a1>, op : forall<e1,b1> (a1<e1,b1>) -> clause1<(a, b, c),d,a1,e1,b1>, x1 : a, x2 : b, x3 : c) -> e d */ 
  {
    struct kk_std_core_hnd_Ev* _con_x480 = kk_std_core_hnd__as_Ev(ev, _ctx);
    int32_t m = _con_x480->marker;
    kk_box_t h = _con_x480->hnd;
    kk_box_dup(h, _ctx);
    kk_std_core_hnd__clause1 _match_x225 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx), _ctx); /*hnd/clause1<(8949, 8950, 8951),8952,8954,1450,1451>*/;
    {
      kk_function_t _fun_unbox_x144 = _match_x225.clause;
      kk_box_t _x_x481;
      kk_std_core_types__tuple3 _x_x482 = kk_std_core_types__new_Tuple3(x1, x2, x3, _ctx); /*(141, 142, 143)*/
      _x_x481 = kk_std_core_types__tuple3_box(_x_x482, _ctx); /*45*/
      return kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x144, (_fun_unbox_x144, m, ev, _x_x481, _ctx), _ctx);
    }
  }
}
...
static inline kk_box_t kk_std_core_hnd__perform4(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x1, kk_box_t x2, kk_box_t x3, kk_box_t x4, kk_context_t* _ctx) { /* forall<a,b,c,d,a1,e,b1> (ev : ev<b1>, op : forall<e1,c1> (b1<e1,c1>) -> clause1<(a, b, c, d),a1,b1,e1,c1>, x1 : a, x2 : b, x3 : c, x4 : d) -> e a1 */ 
  {
    struct kk_std_core_hnd_Ev* _con_x505 = kk_std_core_hnd__as_Ev(ev, _ctx);
    int32_t m = _con_x505->marker;
    kk_box_t h = _con_x505->hnd;
    kk_box_dup(h, _ctx);
    kk_std_core_hnd__clause1 _match_x216 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx), _ctx); /*hnd/clause1<(9644, 9645, 9646, 9647),9648,9650,1606,1607>*/;
    {
      kk_function_t _fun_unbox_x189 = _match_x216.clause;
      kk_box_t _x_x506;
      kk_std_core_types__tuple4 _x_x507 = kk_std_core_types__new_Tuple4(kk_reuse_null, 0, x1, x2, x3, x4, _ctx); /*(150, 151, 152, 153)*/
      _x_x506 = kk_std_core_types__tuple4_box(_x_x507, _ctx); /*45*/
      return kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x189, (_fun_unbox_x189, m, ev, _x_x506, _ctx), _ctx);
    }
  }
}
...
static inline kk_std_core_types__either kk_std_core_hnd_unsafe_try_finalize(kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (action : () -> e a) -> e either<yield-info,a> */ 
  kk_box_t _x_x536 = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), action, (action, _ctx), _ctx); /*11909*/
  return kk_std_core_hnd_try_finalize_prompt(_x_x536, _ctx);
}
