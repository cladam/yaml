...
static inline kk_box_t kk_std_core_exn_throw_exn(kk_std_core_exn__exception exn_0, kk_context_t* _ctx) { /* forall<a> (exn : exception) -> exn a */ 
  kk_std_core_hnd__ev ev_10132 = kk_evv_at(((KK_IZ(0))),kk_context()); /*hnd/ev<exn>*/;
  {
    struct kk_std_core_hnd_Ev* _con_x102 = kk_std_core_hnd__as_Ev(ev_10132, _ctx);
    ...
    kk_std_core_exn__exn_dup(h, _ctx);
    {
      ...
      }
      {
        ...
        return kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x12, (_fun_unbox_x12, m, ev_10132, kk_std_core_exn__exception_box(exn_0, _ctx), _ctx), _ctx);
      }
    }
  }
}
...
static inline kk_std_core_exn__error kk_std_core_exn_error_fs__mlift_try_10130(kk_box_t _y_x10122, kk_context_t* _ctx) { /* forall<a,e> (a) -> <exn|e> error<a> */ 
  return kk_std_core_exn__new_Ok(_y_x10122, _ctx);
}
