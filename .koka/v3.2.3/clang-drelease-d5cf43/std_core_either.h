...
static inline kk_std_core_types__either kk_std_core_either__mlift_map_10110(kk_box_t _y_x10100, kk_context_t* _ctx) { /* forall<a,b,e> (b) -> e either<a,b> */ 
...
static inline kk_string_t kk_std_core_either__mlift_show_10111(kk_string_t _y_x10107, kk_context_t* _ctx) { /* forall<e> (string) -> e string */ 
  kk_string_t _x_x18;
  ...
  _x_x20 = kk_std_core_types__lp__plus__plus__rp_(_y_x10107, _x_x21, _ctx); /*string*/
  return kk_std_core_types__lp__plus__plus__rp_(_x_x18, _x_x20, _ctx);
}
 
// monadic lift

static inline kk_string_t kk_std_core_either__mlift_show_10112(kk_string_t _y_x10108, kk_context_t* _ctx) { /* forall<e> (string) -> e string */ 
  kk_string_t _x_x23;
  ...
  _x_x25 = kk_std_core_types__lp__plus__plus__rp_(_y_x10108, _x_x26, _ctx); /*string*/
