...
kk_std_core_types__order2 kk_std_core_string_order2(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> order2<string> */ 
  kk_std_core_types__order _match_x27 = kk_std_core_string_cmp(x, y, _ctx); /*order*/;
  if (kk_std_core_types__is_Lt(_match_x27, _ctx)) {
    return kk_std_core_types__new_Lt2(kk_string_box(x), kk_string_box(y), _ctx);
  }
  if (kk_std_core_types__is_Gt(_match_x27, _ctx)) {
...
kk_std_core_types__maybe kk_std_core_string_maybe(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> maybe<string> */ 
  bool _match_x17;
  kk_string_t _x_x45 = kk_string_dup(s, _ctx); /*string*/
  kk_string_t _x_x46 = kk_string_empty(); /*string*/
  _match_x17 = kk_string_is_eq(_x_x45,_x_x46,kk_context()); /*bool*/
  if (_match_x17) {
...
kk_string_t kk_std_core_string_pad_left(kk_string_t s, kk_integer_t width, kk_std_core_types__optional fill, kk_context_t* _ctx) { /* (s : string, width : int, fill : ? char) -> string */ 
  kk_integer_t n;
  kk_string_t _x_x48 = kk_string_dup(s, _ctx); /*string*/
  n = kk_std_core_string_chars_fs_count(_x_x48, _ctx); /*int*/
  ...
  }
  {
    ...
    if (kk_std_core_types__is_Optional(fill, _ctx)) {
      ...
      kk_std_core_types__optional_drop(fill, _ctx);
      _x_x49 = _uniq_fill_368; /*char*/
    }
    else {
      kk_std_core_types__optional_drop(fill, _ctx);
      _x_x49 = ' '; /*char*/
    }
    s_0_10011 = kk_std_core_string_char_fs_string(_x_x49, _ctx); /*string*/
    kk_integer_t n_0_10012;
    kk_integer_t _x_x50 = kk_integer_dup(width, _ctx); /*int*/
    n_0_10012 = kk_integer_sub(_x_x50,n,kk_context()); /*int*/
    kk_string_t _x_x51 = kk_std_core_string_repeatz(s_0_10011, kk_std_core_int_ssize__t(n_0_10012, _ctx), _ctx); /*string*/
    return kk_std_core_types__lp__plus__plus__rp_(_x_x51, s, _ctx);
  }
}
...
kk_string_t kk_std_core_string_pad_right(kk_string_t s, kk_integer_t width, kk_std_core_types__optional fill, kk_context_t* _ctx) { /* (s : string, width : int, fill : ? char) -> string */ 
  kk_integer_t n;
  kk_string_t _x_x52 = kk_string_dup(s, _ctx); /*string*/
  n = kk_std_core_string_chars_fs_count(_x_x52, _ctx); /*int*/
  ...
  }
  {
    ...
    if (kk_std_core_types__is_Optional(fill, _ctx)) {
      ...
      kk_std_core_types__optional_drop(fill, _ctx);
      _x_x53 = _uniq_fill_415; /*char*/
    }
    else {
      kk_std_core_types__optional_drop(fill, _ctx);
      _x_x53 = ' '; /*char*/
    }
    s_0_10015 = kk_std_core_string_char_fs_string(_x_x53, _ctx); /*string*/
    kk_integer_t n_0_10016;
    kk_integer_t _x_x54 = kk_integer_dup(width, _ctx); /*int*/
    n_0_10016 = kk_integer_sub(_x_x54,n,kk_context()); /*int*/
    kk_string_t _x_x55 = kk_std_core_string_repeatz(s_0_10015, kk_std_core_int_ssize__t(n_0_10016, _ctx), _ctx); /*string*/
    return kk_std_core_types__lp__plus__plus__rp_(s, _x_x55, _ctx);
  }
}
